...
if  (isset($_GET['id'])) {
  $id = $_GET['id'];
  $query = "SELECT * FROM tabla_clientes WHERE id=$id";
...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE tabla_clientes set nombre = '$nombre', apellido = '$apellido', direccion = '$direccion', telefono = '$telefono', correo = '$correo', codigopostal = '$codigopostal' WHERE id=$id";
